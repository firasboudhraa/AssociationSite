        ...
        <div className="w-full bg-[var(--bgSoft)] p-5 rounded-lg mb-5">
          ...
          <div className="flex flex-col space-y-3">
            <label className="flex items-center space-x-3">
              <input type="radio" name="documentType" className="form-radio text-green-500" defaultChecked />
              <span>Cate d'identité tunisienne</span>
            </label>
            <label className="flex items-center space-x-3">
              <input type="radio" name="documentType" className="form-radio text-green-500" />
              <span>Passeport</span>
            </label>
          </div>
        </div>
