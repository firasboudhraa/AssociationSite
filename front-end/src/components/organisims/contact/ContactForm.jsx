...
const ContactForm = () => {
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      console.log('Submitting data:', { fullname, email, phone, subject, message });
    ...
    <>
      <form className="py-4 mt-4 border-t flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select id="subject" className="w-full p-2 border rounded text-black" value={subject} onChange={(e) => setSubject(e.target.value)}>
